...
def load_ensemble() -> ModelEnsemble:
    ...
    if cfg["training"].get("use_lora", False):
        ...
        resnet = apply_lora(resnet, r=cfg["training"]["lora_rank"], alpha=cfg["training"]["lora_alpha"], dropout=cfg["training"]["lora_dropout"], target_modules=cfg["training"].get("lora_target_modules", ["fc", "classifier"]))
    ...
    if cfg["training"].get("use_lora", False):
        efficientnet = apply_lora(efficientnet, r=cfg["training"]["lora_rank"], alpha=cfg["training"]["lora_alpha"], dropout=cfg["training"]["lora_dropout"], target_modules=cfg["training"].get("lora_target_modules", ["fc", "classifier"]))
    ...
    if cfg["training"].get("use_lora", False):
        baseline = apply_lora(baseline, r=cfg["training"]["lora_rank"], alpha=cfg["training"]["lora_alpha"], dropout=cfg["training"]["lora_dropout"], target_modules=cfg["training"].get("lora_target_modules", ["fc", "classifier"]))
